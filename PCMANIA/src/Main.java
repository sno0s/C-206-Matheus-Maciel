public class Main {
    public static void main(String[] args) {
        ...
        HardwareBasico H1 = new HardwareBasico("Pentium Core i3 (2200 Mhz) 8 Gb de Memória RAM", 500f);
        ...
        computador1.memoria = M1;
        computadores[0] = computador1;

        //Criando a promoção 2
        SistemaOperacional windows8 = new SistemaOperacional("Windows 8", 64);
        HardwareBasico H2 = new HardwareBasico("Pentium Core i5 (3370 Mhz) 16 Gb de Memória RAM", 1000f);
